...
本书研究这个转化过程中的两个核心机制：indexterm2:[Package Discovery]Package Discovery 和 indexterm2:[Package Management]Package Management。
...
本书不比较哪个工具“最好”。本书建立一套对象模型和评价尺度，用于说明不同语言生态如何让包成为可发现、可比较、可求解、可获取、可复现、可审计、可维护的依赖对象。
