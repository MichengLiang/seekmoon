...
`search` 默认读取最新 snapshot 中的 Modules API array。没有可用 snapshot 时，它可以读取 Modules API 并创建 transient snapshot。Query 匹配 module name、description、keywords 和 repository declaration。
