# Prompt For Batch C Re-Reviewer

Read this re-review package first:

`/home/t103o/workbench/projects/seekmoon/bookshelf/books/10-seekmoon-wbs-work-packages/coordination/review-packages/012-batch-c-re-review.md`

Then execute it exactly.

Operational constraints:

- Continue as the independent Batch C reviewer.
...
- If approved, write the re-review report and commit only approved Batch C and coordination paths.
